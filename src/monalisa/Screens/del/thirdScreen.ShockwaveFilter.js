...
export default class thirdScreen extends BasicContainer {
  ...
  animate() {
    ...
    if (this.active) {
      ...
      shock[0].time = shock[0].time >= 3 ? 0 : shock[0].time + 0.01;
      shock[1].time = shock[1].time >= 3 ? 0 : shock[1].time + 0.015;
      shock[2].time = shock[2].time >= 3 ? 0 : shock[2].time + 0.02;
    }
  }
  ...
  init() {
    ...
    const shockWaveFilter2 = new ShockwaveFilter([0, sea.height / 2], {
      amplitude: 93,
      wavelength: 100,
      brightness: 0.9,
      radius: loadingbg.width
    });
    const shockWaveFilter3 = new ShockwaveFilter([0, sea.height], {
      amplitude: 93,
      wavelength: 300,
      brightness: 0.9,
      radius: loadingbg.width
    ...
    sea.filters = [shockWaveFilter1, shockWaveFilter2, shockWaveFilter3];
    this.active = true;
    requestAnimationFrame(this.animate.bind(this));
  ...
  animateScript1() {
    ...
    // 两个控制按钮
    const nextButton = new Sprite(this.res[path + 'RightArrow.png'].texture);
    const repeatButton = new Sprite(this.res[path + 'repeat.png'].texture);
